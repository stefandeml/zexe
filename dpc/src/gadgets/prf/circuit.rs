...
// use sapling_crypto::circuit::{blake2s, boolean, ecc, multipack, num,
// Assignment}; use sapling_crypto::circuit::boolean::{AllocatedBit, Boolean};
...
use snark::{
    gm17::{create_random_proof, generate_random_parameters, prepare_verifying_key, verify_proof},
...
impl<E: PairingEngine> Circuit<E> for Blake2sBench<E> {
    fn synthesize<CS: ConstraintSystem<E>>(self, cs: &mut CS) -> Result<(), SynthesisError> {
        ...
        let hash = blake2s(cs.ns(|| "calculate hash"), &input_bits, b"12345678")?;
...
mod test {
    ...
    use algebra::{
        ...
        fields::{bls12_377::Fr as Fr_Bls12_377, bls12_381::Fr as Fr_Bls12_381, sw6::Fr as Fr_SW6},
    };
    use rand::{thread_rng, Rand};
    use snark::{
        gm17::{
    ...
    fn prove_and_verify_blake2s_cicruit_bls12_377() {
        ...
        let c = Blake2sBench::<Curve> { num_bytes, dummy };
